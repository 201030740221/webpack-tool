...
module.exports.pitch = function(request) {
	...
	if(this[__dirname] === undefined) {
		throw new Error(
			'"extract-css-webpack-plugin" loader is used without the corresponding plugin, ' +
			'refer to https://github.com/webpack/extract-css-webpack-plugin for the usage example'
		);
		...
		var resultSource;
		if(query.remove) {
			resultSource = "// removed by extract-css-webpack-plugin";
		} else {
			resultSource = undefined;
		}

		if(query.extract !== false) {
			var childFilename = "extract-css-webpack-plugin-output-filename"; // eslint-disable-line no-path-concat
			var publicPath = typeof query.publicPath === "string" ? query.publicPath : this._compilation.outputOptions.publicPath;
			var outputOptions = {
				filename: childFilename,
				publicPath: publicPath
			};
			var childCompiler = this._compilation.createChildCompiler("extract-css-webpack-plugin", outputOptions);
